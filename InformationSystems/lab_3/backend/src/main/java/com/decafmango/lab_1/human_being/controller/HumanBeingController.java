...
public class HumanBeingController {
    ...
    @GetMapping("/count")
    public Long getHumanBeingsCount() {
        return humanBeingService.getHumanBeingsCount();
    }
    ...
    @DeleteMapping("/impact-speed/{impactSpeed}")
    public void deleteHumanBeingsByImpactSpeed(@PathVariable Double impactSpeed, HttpServletRequest request) {
    ...
    public void deleteHumanBeingsByToothpick(HttpServletRequest request) {
        humanBeingService.deleteHumanBeingsWithoutToothpick(request);
    }
